...
export default function HourlyWidget(data) {
  ...
  const { date, icon, summary, temperature, precipitation, wind } = data.data;
  ...
  return (
    ...
    <div
      ...
      } hover:scale-110 widget shadow-md h-52 w-40 rounded-lg p-4 m-2 flex flex-col items-center justify-between`}
    >
      ...
      <div className="temperature flex items-center mt-2">
        ...
        <div className="temp text-2xl font-bold">
      ...
      <div className="wind flex items-center mt-2">
        <div className="wind-speed text-sm">
          {Math.round(wind.speed)} {units.wind_speed}
        </div>
        <div
          className="wind-direction ml-2"
